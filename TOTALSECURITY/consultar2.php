...
<head>
    ...
    <link rel="stylesheet" href="css/consultar2.css">
    <title>consultar-2</title>
</head>
    ...
    <table class="table" id="tabla_apren">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <a href="modificar.php?id=<?php echo $row['DOCUMENTO']; ?>"><button class="btn btn-primary">Modificar</button></a>
                    <a href="eliminar.php?id=<?php echo $row['DOCUMENTO']; ?>"><button class="btn btn-danger">Borrar</button></a>
                </td>
            </tr>
            <?php
              }
